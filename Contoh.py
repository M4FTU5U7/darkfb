...
def siapa():
	...
	if nama =="":
		...
		time.sleep(1)
                os.system('clear')
                jalan("\033[1;96m[!] \033[1;91mSUBSCRIBE DULU GAN")
                os.system("termux-open https://www.youtube.com/channel/UC_R9bH0qqDOlJB43WrgBarw")
                loginSC()
...
def loginSC():
	...
	if username =="Maftuhul" and password =="Uzy":
		...
		time.sleep(1)
                print"Password dan ussername salah silahkan tanya di wa berikut ini !!!\n"
                time.sleep(1)
                os.system ("termux-open https://wa.me/6285325608003")
                loginSC()
def login():
	os.system('clear')
	try:
